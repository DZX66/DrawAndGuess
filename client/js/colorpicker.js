							...
							<div class="flexbox-fix" style="display: flex;align-items: center;height: 40px;">
								<div style="width: 32px;">
									<div style="width: 16px; height: 16px; border-radius: 8px; position: relative; overflow: hidden;">
										<div class="colorpicker-showColor" style="position: absolute; top: 0px; right: 0px; bottom: 0px; left: 0px; border-radius: 8px; box-shadow: rgba(0, 0, 0, 0.1) 0px 0px 0px 1px inset; background:rgb(${this.rgba.r},${this.rgba.g},${this.rgba.b}); z-index: 2000;"></div>
...
function mouse(e) {
			...
			elem.addEventListener("mousedown", mouse, false);
			elem.addEventListener("touchstart", function (e) {
				elem.removeEventListener("mousedown", mouse, false);
				_this.downX = e.touches[0].pageX;
				_this.downY = e.touches[0].pageY;
				bool ? fn.call(_this, _this.downX, _this.downY) : fn.call(_this, elem, _this.downX, _this.downY);
